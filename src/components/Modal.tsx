...
export default function Modal({ open, title, onClose, children, footer }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-slate-900/50 p-4 backdrop-blur-sm sm:items-center">
      <div className="w-full max-w-lg rounded-2xl bg-gradient-to-b from-white to-pink-50/40 ring-1 ring-pink-100/70 shadow-[inset_0_1px_0_rgba(255,255,255,0.9),0_30px_60px_-15px_rgba(201,162,39,0.45)]">
